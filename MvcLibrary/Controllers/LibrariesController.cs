...
namespace MvcLibrary.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        public LibrariesController(MvcLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Publisher,ReleaseDate,Genre,Price")] Library library)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Publisher,ReleaseDate,Genre,Price")] Library library)
        {
            if (id != library.Id)
            {
                return NotFound();
